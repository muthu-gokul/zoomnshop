...
import 'package:zoomnshop/pages/loginpage/phone-otp/otp_screen.dart';
...
class PhoneNoPage extends StatefulWidget {
  ...
  @override
  _PhoneNoPageState createState() => _PhoneNoPageState();
}
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text("Enter Mobile",style: TextStyle(fontSize: 30,fontFamily: 'RB',color: Color(0XFF212B3B)),),
                      Text("Number",style: TextStyle(fontSize: 30,fontFamily: 'RB',color: Color(0XFF212B3B)),),
                      SizedBox(height: 10,),
                      Container(
                        child: Text("Please enter Your Mobile Number To Receive a Verification Code.",style: ts16(Color(0XFF7D7D7D)),textAlign: TextAlign.left,),
                      ),
                    ],
                  ),
                ),
