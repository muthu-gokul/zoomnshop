...
// Project imports
import '../../../common/ui/organisms/brb_tag.dart';
import '../../../common/ui/organisms/degrade_tile.dart';
import '../../../common/ui/organisms/hand_raise.dart';
import '../../../common/ui/organisms/audio_mute_status.dart';
import '../../../common/ui/organisms/network_icon_widget.dart';
import '../../../common/ui/organisms/peer_name.dart';
import '../../../common/ui/organisms/tile_border.dart';
import '../../../common/ui/organisms/rtc_stats_view.dart';
import '../../../common/ui/organisms/video_view.dart';
import '../../../data_store/meeting_store.dart';
import '../../../model/peer_track_node.dart';
import '../../../common/ui/organisms/remote_peer_tile_dialog.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      ...
      child: FocusDetector(
        ...
        key: Key(context.read<PeerTrackNode>().uid),
        child: Semantics(
                label: "fl_${context.read<PeerTrackNode>().peer.name}_screen_share_tile",
                child: Container(
                  decoration: BoxDecoration(
                      border: Border.all(color: Colors.grey, width: 1.0),
                      color: Colors.transparent,
